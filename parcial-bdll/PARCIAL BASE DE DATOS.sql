...
CREATE TABLE `academicperiodgroups` (
  ...
  CONSTRAINT `academicperiodgroups_ibfk_3` FOREIGN KEY (`groupId`) REFERENCES `matriculates` (`id`),
...
insert  into `degrees`(`id`,`levelId`,`name`,`createdAt`,`updatedAt`,`abbreviation`) values 
(23,11,'Kinder','2021-11-19 20:14:43',NULL,NULL),
(24,11,'Preparatoria','2021-11-19 20:15:05',NULL,NULL),
(25,11,'Primero Primaria','2021-11-19 20:15:15',NULL,NULL),
(26,11,'Segundo Primaria','2021-11-19 20:15:21',NULL,NULL),
(27,12,'Tercero Primaria','2021-11-19 20:15:46',NULL,NULL),
(28,12,'Cuarto Primaria','2021-11-19 20:15:52',NULL,NULL),
(29,12,'Quinto Primaria','2021-11-19 20:15:58',NULL,NULL),
(30,12,'Sexto Primaaria','2021-11-19 20:16:04',NULL,NULL),
(31,13,'Primero Basico','2021-11-19 20:16:48',NULL,NULL),
(32,13,'Segundo Basico','2021-11-19 20:16:55',NULL,NULL);
...
(10,'Seccion A','2021-11-19 19:44:22',NULL,'A');
...
CREATE TABLE `levels` (
  ...
  `abbreviation` varchar(5) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `levels_ibfk_1` FOREIGN KEY (`id`) REFERENCES `degrees` (`levelId`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8;

/*Data for the table `levels` */

insert  into `levels`(`id`,`name`,`createdAt`,`updatedAt`,`abbreviation`) values 
(11,'Preprimaria y Primaria Baja','2021-11-19 20:13:48',NULL,''),
(12,'Primaria Alta','2021-11-19 20:15:35',NULL,''),
(13,'Secundaria','2021-11-19 20:16:39',NULL,'');
